...
writer = SummaryWriter('logs/WGAN')
lossg2=[]
lossd2=[]
...
for epoch in range(opt.n_epochs):
    ...
    for i, imgs in enumerate(dataloader):
        ...
        lossg1 = lossg1 + loss_D.item()
        lossd1 = lossd1 + loss_G.item()

        writer.add_scalar('Loss/Generator', lossg1, epoch)
        writer.add_scalar('Loss/Discriminator', lossd1, epoch)

    if epoch%1000 ==0:
        torch.save(generator, './savemodel/WGAN/WGAN_G_{}.pth'.format(epoch))
        torch.save(discriminator, './savemodel/WGAN/WGAN_D_{}.pth'.format(epoch))
